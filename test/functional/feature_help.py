...
"""Verify that starting deepcoin with -h works as expected."""

from test_framework.test_framework import DeepcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(DeepcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start deepcoin with -h for help text")
        ...
        self.log.info("Start deepcoin with -version for version information")
        ...
        self.log.info("Start deepcoind with -fakearg to make sure it does not start")
