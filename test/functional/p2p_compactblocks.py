...
# TestP2PConn: A peer we use to send messages to deepcoind, and store responses.
...
class CompactBlocksTest(DeepcoinTestFramework):
    ...
    # This test actually causes deepcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that deepcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for deepcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # deepcoind will not send blocktxn responses for blocks whose height is
