...
class BIP66Test(DeepcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # deepcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and deepcoind produces more specific reject
            # reasons.
