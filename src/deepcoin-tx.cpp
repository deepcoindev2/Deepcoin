...
static void SetupDeepcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " deepcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  deepcoin-tx [options] <hex-tx> [commands]  Update hex-encoded deepcoin transaction\n" +
            "or:     deepcoin-tx [options] -create [commands]   Create hex-encoded deepcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded deepcoin transaction
