 ...
 */
#ifndef DEEPCOIN_UTIL_H
#define DEEPCOIN_UTIL_H
...
extern const char * const DEEPCOIN_CONF_FILENAME;
extern const char * const DEEPCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("deepcoin-%s", name);
