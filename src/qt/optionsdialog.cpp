    ...
    mapper(0)
{
    ...
    ui->deepcoinAtStartup->setToolTip(ui->deepcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->deepcoinAtStartup->setText(ui->deepcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openDeepcoinConfButton->setToolTip(ui->openDeepcoinConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new DeepcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->deepcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openDeepcoinConfButton_clicked()
{
