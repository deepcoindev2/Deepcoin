...
#ifndef DEEPCOIN_QT_DEEPCOINUNITS_H
#define DEEPCOIN_QT_DEEPCOINUNITS_H
...
/** Deepcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class DeepcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit DeepcoinUnits(QObject *parent);

    /** Deepcoin units.
      @note Source: https://en.deepcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        DPC,
...
typedef DeepcoinUnits::Unit DeepcoinUnit;

#endif // DEEPCOIN_QT_DEEPCOINUNITS_H
