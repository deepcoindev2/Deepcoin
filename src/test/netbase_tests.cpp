...
{
    BOOST_CHECK(TestSplitHost("www.deepcoincore.org", "www.deepcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.deepcoincore.org]", "www.deepcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.deepcoincore.org:80", "www.deepcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.deepcoincore.org]:80", "www.deepcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:6918", "127.0.0.1", 6918));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:6918", "127.0.0.1", 6918));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:6918", "::ffff:127.0.0.1", 6918));
    BOOST_CHECK(TestSplitHost("[::]:6918", "::", 6918));
    BOOST_CHECK(TestSplitHost("::6918", "::6918", -1));
    BOOST_CHECK(TestSplitHost(":6918", "", 6918));
    BOOST_CHECK(TestSplitHost("[]:6918", "", 6918));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:6918", "127.0.0.1:6918"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:6918", "[::]:6918"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
