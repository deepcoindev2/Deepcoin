...
#ifndef DEEPCOIN_TEST_SCRIPTNUM10_H
#define DEEPCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Deepcoin Core 0.10.0, for cross-comparison.
 */
public:
