...
#ifndef DEEPCOIN_KEYSTORE_H
#define DEEPCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/deepcoin/bips/blob/master/bip-0013.mediawiki
