...
#ifndef DEEPCOIN_INTERFACES_NODE_H
#define DEEPCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a deepcoin node (deepcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // DEEPCOIN_INTERFACES_NODE_H
