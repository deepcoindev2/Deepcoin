...
#ifndef DEEPCOIN_WALLET_WALLET_H
#define DEEPCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this deepcoin node, and set to 0 for transactions that were created
...
#endif // DEEPCOIN_WALLET_WALLET_H
