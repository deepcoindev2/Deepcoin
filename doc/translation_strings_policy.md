...
This document provides guidelines for internationalization of the Deepcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `deepcoin_en.ts` remains unchanged.
