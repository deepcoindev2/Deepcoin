...
* deepcoin.conf: contains configuration settings for deepcoind or deepcoin-qt
* deepcoind.pid: stores the process id of deepcoind while running
...
* debug.log: contains debug information and general logging generated by deepcoind or deepcoin-qt
